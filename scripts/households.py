...
def FOCs(b_sp1, n_s, *args):
    ...
    n is not contained in the remaining arguments anymore. If someone decides to change
         this, please provide detailed documentation on why you are doing so.
    ...
    lhs_euler_b = mu_c
    rhs_euler_b = beta * (1+r) * (1 - rho_s) *  mu_c
    foc_errors_b = lhs_euler_b[:-1] - rhs_euler_b[1:]
    # The above line doesn't need to be changed since it works for 
    # a general S as well (writing out the vectors helps to see this)
